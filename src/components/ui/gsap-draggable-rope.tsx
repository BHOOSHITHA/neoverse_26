  ...
  const Icon = (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        ></path>{" "}
        <path
          d="m27.57 24.68c.2-.08 7.63 3.33 7.54 3.70s-3 6.17-3.16 6.17-6.95-3.21-6.95-3.55 2.24-6.2 2.57-6.32z"
          fill="#e7413e"
        ></path>{" "}
        <g fill="#1d1d1b">
          {" "}
        ...
        ></path>{" "}
        <path
          d="m14 43.38c.27-.26.58.88 1.25 1.09s1 .25 1.08.46.17.62-.12.70a1.25 1.25 0 0 1 -1.13-.29c-.46-.33-.79-.87-1.21-1s-.58 0-.54-.2.57-.63.67-.76z"
          fill="#1d1d1b"
        ></path>{" "}
        <path
